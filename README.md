...
- Events can be removed from the public website with `visibleOnWebsite: false`; authenticated panel users can update content, visibility, and soft-delete events.
